<i18n>
  ...
  "intro02":"預先購買墓地Ｘ葬禮需要深思熟慮的決定，因此在你需要的時候，我們樂於為你提供詳盡諮詢，專業真誠的服務與加拿大多元文化的結合，讓你做Ｘ最合適的安排，毫無後顧之憂。一站式服務包括墓地，骨灰位，葬禮以及火化的各類安排。",
      ...
      <b-container>
        <b-row>
          ...
          <b-col cols="12" md="6" sm="12">
            <h2>
              <b-img src="/img/arbor-logo.png" width="150" fluid /> | 公司历史 </h2>
            <p>{{$t('history01')}}</p>
            <p>{{$t('history02')}}</p>
    ...
    <section id="service">
      <b-container>
        ...
        <b-row>
          ...
          <b-col cols="12" md="4" sm="12" data-aos="fade-up" data-aos-delay="750">
